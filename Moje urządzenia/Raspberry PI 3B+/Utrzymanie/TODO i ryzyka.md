...
- [ ] Po każdym audycie albo zmianie kontenera aktualizować [[Moje urządzenia/Raspberry PI 3B+/Docker i kontenery/Uruchomione kontenery i role|Uruchomione kontenery i role]]: stan `Up/Exited`, rola, porty, zależności i krótka notatka, co kontener ma robić.
