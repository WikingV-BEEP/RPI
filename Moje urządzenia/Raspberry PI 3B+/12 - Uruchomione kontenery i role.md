...
Pełna techniczna rozpiska compose, portów, mountów i env bez sekretów jest w: [[Moje urządzenia/Raspberry PI 3B+/11 - Kontenery skonfigurowane|Kontenery skonfigurowane]].
