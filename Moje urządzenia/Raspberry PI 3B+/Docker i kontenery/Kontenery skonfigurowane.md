...
Szybka lista kontenerów, które powinny być uruchomione, oraz ich roli jest w: [[Moje urządzenia/Raspberry PI 3B+/Docker i kontenery/Uruchomione kontenery i role|Uruchomione kontenery i role]].
